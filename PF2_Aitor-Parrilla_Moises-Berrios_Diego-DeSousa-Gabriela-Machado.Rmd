...
power_bt_power <- power_bt_power_total_df  %>%  
  ...
  scale_color_manual(name="Fuente de poder",breaks=c('energia creada total','energia requerida cripto'),values = c('power'='magenta','power cripto'='blue'))+
  theme(axis.title=element_text(size=10,face="bold"),axis.text.x = element_text(size = 8,angle = 60))
power_bt_power
```

**Figura 2: Energia creada  vs Energia Requerida por la cripto** 
...
Regresando al grafico de la figura 10 (Energia creada total vs Volumen de transacciones), No existe una fuerte correlación entre el volúmen de transacciones y la energía generada. Esto puede deberse a que el dataset seleccionado no considera patrones de consumo energético ni las transacciones de criptomonedas:
